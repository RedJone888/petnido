...
import type { PublicServiceDto } from "@/domain/marketplace/service-public-dto";
...
export function PublicServiceDetail({
  ...
  const service = trpc.marketplaceService.get.useQuery(

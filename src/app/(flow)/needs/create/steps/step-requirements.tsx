...
export function StepBoardingRequirements({
  ...
  const ui = {
    en: {
      ...
      mustHaveDetail: "Choose what the sitter or home must provide for your pet.",
    ...
    zh: {
      ...
      situationsDetail: "只选择不适合宠物寄养的情况；如果没有限制，可以全部不选。",
      avoid: "避开",
    },
    ja: {
      mustHave: "お世話・家庭の必須条件",
      mustHaveDetail: "ペットのためにシッターや預かり家庭が必ず用意すべき条件を選びます。",
      situations: "避けたい家庭環境",
      situationsDetail: "滞在に適さない状況だけを選びます。制限がなければ、何も選択しなくて構いません。",
      avoid: "避ける",
    },
  }[lang];

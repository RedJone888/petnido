...
export function StepArea({
  ...
  const copy = t.core.needPublishingArea;
  const privacyCopy = {
    en: {
      reminder:
  ...
  return (
    <div className={cn("space-y-6", careType === "boarding" && "space-y-5")}>
      ...
      <div className="inline-flex w-fit max-w-full items-start gap-2.5 rounded-xl border border-amber-200 bg-amber-50 px-3.5 py-3 text-xs font-semibold leading-5 text-amber-900">
        ...
        <span>{privacyCopy.reminder}</span>
      </div>
      {careType === "boarding" && (
        <>
...
function AreaLocationEditor({
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-start gap-3 md:max-w-[calc(100%_-_215px)] lg:max-w-[calc(100%_-_225px)]">
...
function SavedLocationPicker({
  ...
  return (
    <div ref={pickerRef} className="relative z-30 mt-[23px] shrink-0">
      <button
        type="button"
        aria-expanded={open}

  ...
  return (
    <div className="group relative bg-white border border-slate-200 rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full overflow-hidden">
      ...
      <div className="p-4 flex-1 flex flex-col space-y-3">
        ...
        {/* 第二行：日期（分行放置） */}
        <div className="flex items-center gap-3 bg-slate-50/80 px-3 py-1.5 rounded-2xl border border-slate-100/50 text-[11px] font-bold text-slate-600">
        ...
        <div className="flex items-center justify-between text-[10px] bg-slate-50/80  px-3 py-1.5 rounded-2xl border  border-slate-100/50 font-bold text-slate-600">
          {/* 增加国旗和币种，明确日元身份 */}
        ...
        <div className="mt-auto flex gap-2">
          ...
          <Button
            // onClick={() => handleContact(user.id)}
            className="flex-[1.2] shadow-lg shadow-purple-100 active:scale-95"
          >
            応募する
          </Button>
        </div>

...
import TimeAndArea from "./TimeAndArea";
...
export function ServiceForm({ initialData, onSubmit, isLoading }: Props) {
          ...
          >
            <div className="bg-gray-50 p-6 max-w-4xl mx-auto space-y-6">
              ...
              >
                ...
                <BaseInfo serviceType={serviceType} />
              </section>
              <section
                id="photo"
                className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-4"
              ...
              >
                ...
                <TimeAndArea locController={locController} />
              </section>
              <section
                id="rule"
                className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-4"

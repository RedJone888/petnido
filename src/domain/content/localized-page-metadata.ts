...
const copy: Record<LocalizedPage, Record<Lang, { title: string; description: string }>> = {
  ...
  services: {
    ...
    zh: { title: "附近的宠物照护服务 | PetNido", description: "寻找正在接单的上门、寄养和自定义照护服务。" },
    ja: { title: "近くのペットケアサービス | PetNido", description: "受付中の訪問、ペット預かり、カスタムケアを探せます。" },
  },
  providers: {
  ...
  "care-types": {
    ...
    zh: { title: "比较三种宠物照护方式 | PetNido", description: "比较上门照护、宠物寄养和自定义宠物服务。" },
  ...
  "care-boarding": {
    ...
    zh: { title: "宠物宠物寄养 | PetNido", description: "了解宠物寄养适用的情况，以及环境与接待容量如何确认。" },
  ...
  "care-custom": {
    ...
    zh: { title: "自定义宠物服务 | PetNido", description: "了解如何描述安全、合法且任务边界清晰的自定义照护。" },
